        ...
        data.append(
            {"city": venue.city,
             ...
             "venues": [{
                 "id": venue.id,
                 "name": venue.name,
                 "num_upcoming_shows": len(venue["name"])
             }]}
        )
...
def search_venues():
    ...
    search_term = Artist.query.filter(Artist.name.ilike('%' + search_term + '%')).all()
    data = []
    for artist in search_term:
        data.append(
            {"id": artist.id,
             "name": artist.name,
...
def show_artist(artist_id):
    ...
    for show in shows:
        show_data = [{
            ...
            "start_time": show.venue.start_time
        }]
